...
internal partial class MarkdownDialog : Window
{
    ...
    public MarkdownDialog()
    {
        ...
        titleLabel.Content = "Update Available";
    }

    public void ResizeMessageWindow(int w, int h)
    {
        messageTextBlock.Width = w;
        messageTextBlock.Height = h;
    }
    public void ResizeMDMessageWindow(int w, int h)
    {
        markDownScrollViewer.Width = w;
        markDownScrollViewer.Height = h;
    }
